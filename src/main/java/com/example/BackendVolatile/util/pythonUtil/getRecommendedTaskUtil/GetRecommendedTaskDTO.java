...
@Data
public class GetRecommendedTaskDTO {

    public Integer recommended_task_num;
    public String algorithm;
    public Double recommendation_threshold;
    public UserInfo user;
    public Rule recommendation_rules;
}
...
class Rule{
    ...
    public Rule(List<String> eu,List<String> et,List<String> du,List<String> dt){
        ...
        this.emphasized_user_features = eu;
        this.desalted_user_features = du;
        this.emphasized_task_features = et;
        this.desalted_task_features = dt;
    }
